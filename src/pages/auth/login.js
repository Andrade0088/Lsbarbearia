    ...
    <div style="height:100vh;display:flex;flex-direction:column;justify-content:center;overflow:hidden;
      ...
      <div id="tipo-selector" style="padding:0 24px;">
        ...
        <div onclick="showLoginForm('cliente')"
          ...
          border:1px solid rgba(255,255,255,.1);border-radius:14px;margin-bottom:12px;cursor:pointer;transition:.2s;"
          onmouseover="this.style.borderColor='var(--red)'" onmouseout="this.style.borderColor='rgba(255,255,255,.1)'">
        ...
        <div onclick="showLoginForm('adm')"
          style="display:flex;align-items:center;gap:14px;padding:16px;background:var(--card);
          border:1px solid rgba(255,255,255,.1);border-radius:14px;cursor:pointer;transition:.2s;"
          onmouseover="this.style.borderColor='var(--red)'" onmouseout="this.style.borderColor='rgba(255,255,255,.1)'">
